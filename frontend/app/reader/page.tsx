...
export default function ReaderPage() {
  ...
  async function connectHuggingFace() {
    if (!huggingFaceRepo.trim() || !huggingFaceToken.trim()) return;
    setConnectingHuggingFace(true); setError("");
    try {
      await connectHuggingFaceLibrary(huggingFaceRepo.trim(), huggingFaceToken.trim());
      await refreshLibrary();
